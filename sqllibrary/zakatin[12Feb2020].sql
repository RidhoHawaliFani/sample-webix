...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2020 at 03:09 PM
...
(7, 'eka', '79ee82b17dfb837b1be94a6827fa395a', 'Sri Eka Riyani H', '6285264397615', 'Jl Melur Pekanbaru', 'Mahasiswa', '1', 0, 1, '2019-11-13 18:51:26'),
(8, 'ridho', '926a161c6419512d711089538c80ac70', 'Ridho Hawali', '6285264397615', 'Kuantan Singingi', 'IT Developer', '1', 0, 1, '2019-11-17 12:55:04'),
...
(27, 7, 'Zakat perniagaan', '6250000', '10.05', '', '2020-02-11 18:23:23', 'Belum Bayar'),
(28, 8, 'Zakat perniagaan', '2500000', '4.02', '', '2020-02-12 09:21:12', 'Belum Bayar'),
(30, 7, 'Zakat perniagaan', '575000', '9.20', '', '2020-02-12 14:35:37', 'Belum Bayar');
...
--
ALTER TABLE `tagihanzakat`
  MODIFY `idTagihan` int(240) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `zakat`
--
ALTER TABLE `zakat`
  MODIFY `idZakat` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
COMMIT;
